...
contract Demo05 is Script {
    ...
    // Case: SellOrderPartiallyFulfilledByMultipleBuyOrders
    ...
    function run() public {
        ...
        swapRouter.swap(
            key,
            IPoolManager.SwapParams({zeroForOne: true, amountSpecified: -20, sqrtPriceLimitX96: 100}),
            testSettings,
        ...
        swapRouter.swap(
            key,
            IPoolManager.SwapParams({zeroForOne: true, amountSpecified: -30, sqrtPriceLimitX96: 120}),
            testSettings,
        ...
        swapRouter.swap(
            key,
            IPoolManager.SwapParams({zeroForOne: false, amountSpecified: -60, sqrtPriceLimitX96: 100}),
            testSettings,
            abi.encode(100, msg.sender)
        );
        ...
        swapRouter.swap(
            key,
            IPoolManager.SwapParams({zeroForOne: true, amountSpecified: -10, sqrtPriceLimitX96: 100}),
            testSettings,
            abi.encode(100, msg.sender)
        );
        vm.stopBroadcast();
